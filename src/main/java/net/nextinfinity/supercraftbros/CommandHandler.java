...
import com.nextinfinity.supercraftbros.commands.*;
import net.nextinfinity.supercraftbros.util.Message;
import net.nextinfinity.supercraftbros.commands.*;
...
public class CommandHandler implements CommandExecutor
{
	...
	public boolean onCommand(CommandSender sender, Command cmd1, String commandLabel, String[] args){
		...
		if(cmd.equalsIgnoreCase("scb")){ 
			if(player.hasPermission("scb.entity") || player.hasPermission("scb.admin")){
				if(args == null || args.length < 1){
					...
					//Message.send(entity, ChatColor.GOLD +"Type /scb help for help" );
